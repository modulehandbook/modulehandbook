...
ActiveRecord::Schema[7.1].define(version: 20_240_714_115_034) do
  ...
  create_table 'course_programs', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[course_id program_id], name: 'index_course_programs_on_course_id_and_program_id', unique: true
