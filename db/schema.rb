...
ActiveRecord::Schema[7.0].define(version: 2021_06_10_095626) do
  ...
  create_table "course_programs", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
  ...
  create_table "courses", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    t.text "name"
    t.text "code"
    t.text "mission"
    t.integer "ects"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.decimal "lectureHrs", precision: 10
    t.decimal "labHrs", precision: 10
    t.decimal "tutorialHrs", precision: 10
    t.text "equipment"
    t.text "room"
    t.string "aasm_state"
  ...
  create_table "programs", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    t.text "name"
    t.text "code"
    t.text "mission"
    t.text "degree"
  ...
  create_table "versions", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    t.string "item_type"
    t.string "{:null=>false}"
